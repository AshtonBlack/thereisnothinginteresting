...
namespace BotForDima
{
    public partial class Form1 : Form
    {
        ...
        private void BranchClubs()
        {
            ...
            while (true)
            {
                ...
                if (fc.ActiveEvent())
                {
                    NotePad.DoLog("Не могу работать при активном событии");//На время сбора инфы
                    /*
    ...
    public class SpecialEvents
    {
        ...
        public void UpgradeAdsKiller()//for dima
        {
    ...
    public class FastCheck
    {
        ...
        public bool FilterIsOpenned()//for dima
        {
            bool x = false;
            ...
            Rectangle FilterIsOpennedBounds = new Rectangle(1110, 173, 30, 22);
    ...
    public class ChooseEvent
    {
        ...
        Rectangle Condition1Bounds = new Rectangle(1184, 325, 203, 19);// for dima
        Rectangle Condition2Bounds = new Rectangle(1163, 352, 224, 22);// for dima
        string Condition1 = "Condition1\\test";
        string Condition2 = "Condition2\\test";

        Rectangle EventNameBounds = new Rectangle(1163, 214, 250, 22);// for dima
        string EventNamePath = "Events\\Test";

        Rectangle RQBounds = new Rectangle(1325, 300, 92, 17);// for dima
        string RQPath = "RQ\\test";

        public int Selection(int eventN)
        {
            Point n1 = new Point(1227, 502);// for dima
            Point n2 = new Point(1227, 592);// for dima
            Point n3 = new Point(1227, 682);// for dima
            Point n4 = new Point(1227, 772);// for dima
            ...
            do
            {
                ...
                if (fc.MissClick())
                {
                    f1.Clk(1336, 163);// for dima
                    flag = false;
                    Thread.Sleep(1000);
                }
                if (fc.EventPage())
                {
                    f1.Clk(400, 420);//Clubs for dima
                    flag = false;
                    Thread.Sleep(15000);
                }
                Thread.Sleep(2000);
            } while (flag == false);//обход ошибок
            ...
            if (MasterOfPictures.Verify(Condition2, "Condition2\\CC0"))
            {
                ...
                if (x != 500)//Исключаю неизвестный
                {
                    ...
                    if (rq > 17) //записывать исключения
                    {
            ...
            x = 500; //ВРемянка для сбора данных, позже УДАЛИТЬ!!!!!
            return x;
        }
            ...
            while (x == 500)
            {
                for (int i = 1; i < 5; i++)
                {
                    do
                    {
                        ...
                        Thread.Sleep(100);
                        fc.Bounty();
                        if (fc.EventPage()) f1.Clk(400, 420);//Clubs for dima
                    } while (!fc.ClubMap());

                    x = Selection(i);
                    if (x == 500)
                    {
                        f1.Clk(1095, 193);//for dina
                        Thread.Sleep(3000);
                    }
                    else
                    {
        ...
        public int GotRQ()//for dima
        {
            ...
            if (rq == 0)
            {
                ...
                for (int x = 1; x < 100; x++)
                {
                    if (File.Exists("C:\\BotForDima\\RQ\\UnknownRQ" + x + ".jpg"))//for dima
                    {
                    ...
                    {
                        File.Move("C:\\BotForDima\\" + RQPath + ".jpg", "C:\\BotForDima\\RQ\\UnknownRQ" + x + ".jpg");//for dima
                        NotePad.DoLog("Сделал скрин");
                        break;
                    }
                }
        ...
        public int WhichEvent()//for dima
        {
            int eventName = 0;
            MasterOfPictures.BW2Capture(EventNameBounds, EventNamePath);
            for (int i = 1; i < 40; i++)
            {
                if (File.Exists("C:\\BotForDima\\Events\\" + i.ToString() + ".jpg"))//for dima
                {
                ...
                else
                {
                    ...
                    File.Move("C:\\BotForDima\\" + EventNamePath + ".jpg", "C:\\BotForDima\\Events\\" + i.ToString() + ".jpg");//for dima
                    NotePad.DoLog("Сделал скрин");
                    break;
                }
            }
