...
namespace WindowsFormsApp1
{
    static class CarsDB
    {
        ...
        public static void MakeCondAuto(int i, int i2)
        {
            List<int> rq;            
            string grade;
            string t;
            ...
            {
                if (SatisfyTopCondition(i, j) && SatisfyBottomCondition(i2, j))
                {
        ...
        public static bool SatisfyTopCondition(int n, int car)
        {
            bool x = false;
            int year;
            string tag;
        ...
        public static bool SatisfyBottomCondition(int n, int car)
        {
            bool x = false;
            int year;
            string tag;
