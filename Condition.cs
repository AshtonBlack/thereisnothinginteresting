...
namespace WindowsFormsApp1
{
    ...
    {
        public static int accountLVL = 465;
        ...
        public static int conditionTopNumber { get; set; }
        public static int conditionBottomNumber { get; set; }
        ...
        public static void MakeCondition(int top, int bottom)
        {            
            conditionTopNumber = top;
            conditionBottomNumber = bottom;
            CarsDB.MakeCondAuto(top, bottom);
